from modules.classData import Getdata
from tkinter import *
import os
...
class Aplication():
    ...
    def conf_window(self):
        self.App.title("PyCep - Painel de Consulta")
        self.App.geometry("480x350")
        self.path = os.path.dirname(os.path.realpath(__file__))
        self.App.wm_iconbitmap(self.path+'\img\map.ico')
        self.App.minsize(width=480, height=350)
        self.App.maxsize(width=600, height=350)
        self.App.configure(background="#fff")
    ...
    # ------------- CONFIGURAÇÃO DE SEGUNDO FRAME/WIDGETS DE ENDEREÇO --------------- #
        ...
        self.input_data = Entry(self.box_search, borderwidth=1, foreground="black", font="Arial 12", justify="center")
